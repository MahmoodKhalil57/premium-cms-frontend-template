/**
 * Shared field model — VERBATIM COPY of marketplace/plugins-src/shared/fields.ts
 * (the server is authoritative; this copy gives the storefront instant feedback).
 *
...
export const FIELD_TYPES = ["text", "email", "textarea", "number", "tel", "url", "date", "select", "radio", "checkbox", "checkbox-group", "file", "hidden", "swatch", "image-choice", "design"] as const;
